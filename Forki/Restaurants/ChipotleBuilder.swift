//
//  ChipotleBuilder.swift
//  Forki
//
//  Build-your-own component for Chipotle
//

import SwiftUI

struct ChipotleBuilder: View {
    ...
    private var categories: [String] {
        ...
        // Custom order for Chipotle: Protein or Veggie > Rice > Beans > Toppings > Chips & Dips > Single Sides > Drinks
        let order = ["Protein or Veggie", "Rice", "Beans", "Toppings", "Chips & Dips", "Single Sides", "Drinks"]
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Select the ingredients in your custom bowl, burrito, or tacos")
                    .font(.system(size: 14, weight: .medium))
                    .foregroundColor(Color(hex: "#6B7280"))
            }
            
            // Totals card (shown when items selected)
